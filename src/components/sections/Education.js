                ...
                <p>
                    ...
                    <ul>
                        ...
                        <dd>
                            ...
                            times in a train network. It then calculates all pairs shortest paths, and the average
                            travel time in the network. The user can change travel times in the network and thereby see
                            what effect a train speed upgrade of a specific connection has to the average travel time in
                            the whole network.
                        </dd>
                    </ul>
                </p>
